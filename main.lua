...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Thanhlam09/skibidi/refs/heads/main/attack"))()
function CheckQuest() 
...
function TPB(CFgo, seat)
    ...
    local info = TweenInfo.new((seat.Position - CFgo.Position).Magnitude / 300,Enum.EasingStyle.Linear)
